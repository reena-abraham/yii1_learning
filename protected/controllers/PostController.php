...
class PostController extends Controller
{
	...
	public function accessRules()
	{
		...
		// 		'actions' => array('create', 'update','testUserId'),
		// 		'users' => array('@'),
		// 	),
		// 	array(
		...
		// 		// 'users' => array('admin'),
		// 		'users'=>array('@'),  // all logged-in users
		// 	),
		// 	array(
		// 		'deny',  // deny all users
		// 		'users' => array('*'),
		...
		// );
		//  return array(
        // array('allow',  // allow admin all actions
        //     'expression'=>'Yii::app()->user->role_id == 1',
        // ),
        // array('allow',  // allow users with specific permissions to perform CRUD
        //     'actions'=>array('create','update','delete','view','index'),
        //      'expression'=>'Yii::app()->user->role_id == 2 && in_array("createPost", Yii::app()->user->getState("permissions"))',
        // //    'expression'=>function() {
        // //         $roleId = Yii::app()->user->role_id;
        // //         $permissions = Yii::app()->user->getState('permissions', []);
        // //         if ($roleId != 2) return false; // or adjust for your roles
                
        // //         // Check permissions depending on action
        // //         $action = Yii::app()->controller->action->id;
        // //         if ($action == 'index' || $action == 'view') {
        // //             return in_array('viewPost', $permissions);
        // //         } elseif ($action == 'create') {
        // //             return in_array('createPost', $permissions);
        // //         } elseif ($action == 'update') {
        // //             return in_array('updatePost', $permissions);
        // //         } elseif ($action == 'delete') {
        // //             return in_array('deletePost', $permissions);
        // //         }
        // //         return false;
        // //     },
		// ),
   ...
   return array(
        array('allow', // admin has full access
            'expression' => 'Yii::app()->user->role_id == 1',
        ),
        array('allow', // role 2 users can view only their own posts and access create/update/delete based on permissions
